...
The stack uses the verified release image `ghcr.io/itoms-hub/bearbiz:1.1.9`.
...
secrets. Pushes to `main` publish `latest` and an immutable SHA tag. Version tags such as `v1.1.9` publish `1.1.9`, `1.0`, `1`, and a SHA tag. The compose
